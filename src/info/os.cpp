...
static const String name("Operating System Information");
static const Word priority=1;
static const String identifier("os");
static const String help("Display information about the operating system on which the server is running.");
static const String os_banner("OPERATING SYSTEM:");


class OSInfo : public Module, public InformationProvider {
